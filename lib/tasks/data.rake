...
#assumes dispensaries are created already
  ...
  ### DVU: 300 stores were missing from production push 10152014, so we splice them in with these tasks below..
  ### mostly copies of the above tasks, but just points to a different import file
  task :alphaPatchImportMenuItems => :environment do
    #file = File.open("./lib/tasks/menuitems_daniel.txt")
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixmenuitems.txt")
    logger = Logger.new('logfile.log')
    logger.info "Start importing items"
  ...
  task :alphaPatchImportAddresses => :environment do
    #file = File.open("./lib/tasks/addresses.txt")
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixaddresses.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    file.each do |line|
  ...
  #daniel scrubed store promos, store names and emails in this alpha one off
task :alphaPatchImportPromosStoreNamesAndEmails => :environment do
    #schema
    #store id<store name<promo<email
    #file = File.open("./lib/tasks/addresses.txt")
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixPromosAndNames.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    logger = Logger.new('logfile.log')
  ...
  task :alphaPatchImportPhonenumbers => :environment do
    #file = File.open("./lib/tasks/phonenumbers.txt")
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixphonenumbers.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    file.each do |line|
  ...
  task :alphaPatchImportStorehours => :environment do
    #file = File.open("./lib/tasks/storehours.txt")
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixstorehours.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    file.each do |line|
  ...
  task :alphaPatchImportWebsites => :environment do
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixwebsites.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    file.each do |line|
  ...
  task :alphaPatchImportStoreFeatures => :environment do
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixstorefeatures.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    file.each do |line|
  ...
  task :alphaPatchImportSocial => :environment do
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixSocial.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    file.each do |line|
  ...
  task :alphaPatchImportDeliveryareas => :environment do
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixDeliveryareas.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    file.each do |line|
  ...
  task :alphaPatchImportGeo => :environment do
    #file = File.open("./lib/tasks/addresses.txt")
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixGeo.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    logger = Logger.new('logfile.log')
      ...
      if syncid != 0  #if attrs[0] is an error string "Error", don't import
        ...
        if (@store)
          if( attrs.last != "ERROR: check fields")          
            ...
            @store.latitude = attrs[2]
            @store.longitude = attrs[3]
  ...
  task :alphaPatchImportGeo2 => :environment do
    #file = File.open("./lib/tasks/addresses.txt")
    file = File.open("./lib/tasks/alpha_patch_10152014/300StoreFixGeo2.txt")
    totalitemsread = 0
    totalitemssaved = 0
    totalitemsskipped = 0
    logger = Logger.new('logfile.log')
