...
feature "plan three" , :js => true do
	...
	scenario "plan 3 can change store promo" do
	...
	scenario "plan 3 can change store announcement" do
		page.visit("/users/sign_in")
		login_page = LoginPage.new
	...
	scenario "plan 3 can change business description" do
	...
	scenario "plan 3 can change dispensary features" do
